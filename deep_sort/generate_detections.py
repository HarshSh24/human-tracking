...
def parse_args():
    ...
    parser.add_argument(
        "--model",
        default=r"C:\Users\HP\OneDrive\Desktop\Deep-SORT-YOLOv4-master\tensorflow2.0\deep-sort-yolov4-low-confidence-track-filtering\model_data\mars-small128.pb",
